    ...
    <div>
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div>
          ...
          <p className="text-brand-cream/60 mt-2">Add, edit, and update pickle products with pricing, stock, and visibility settings.</p>
        </div>
        <Button variant="outline" onClick={handleCreate} className="py-2 px-4">
